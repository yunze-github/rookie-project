...
<table cellpadding=3 cellspacing=1 align=center class=tableborder1>
	...
	<c:forEach items="${sessionScope.userorder.order }" var="order" varStatus="status">
		<tr>
			...
			<td class=tablebody1 valign=middle align=center width=""><input
				...
				onclick="javascript:window.location='user/orderRemove?id=${order.id }';">&nbsp;
				<input type="button" value="明细"
				onclick="javascript:window.location='user/orderInfo?id=${order.id }';">
			</td>
		</tr>
	</c:forEach>
